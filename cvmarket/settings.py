"""
Django settings for cvmarket project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-hotm7*piwyvt10jnts6_zro@gaso&--*r@*!*uewuj@k+!f-)q') 
...
WSGI_APPLICATION = 'cvmarket.wsgi.application'
